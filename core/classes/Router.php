...
class Router extends \Core\Abstracts\Router
{
    ...
    //Routeris padaro, kad nereiketu kitu php puslapiu jis paima url ir tda paziuri kuri kontroleli kviesti
    // ateina requestas, tada routeris ta requesta nukreipia i kontroleli ir kontrolelis  paduoda atsakyma ir ispausdina
    //Routeris gauna requestus ir jis paskirsto i contrilerius.
    /**
